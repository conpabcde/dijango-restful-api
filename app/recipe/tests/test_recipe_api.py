...
def create_user(**params):
    """create test user for recipe test"""
...
class PublicBasicAPITests(TestCase):
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_partial_update(self):
        ...
        payload = {'title': 'New example recipe title'}
        url = detail_url(recipe.id)
    ...
    def test_full_update(self):
        ...
        payload = {
            'title': 'New sample rcipe title',
            'link': 'https://new_sample.com/recipe.pdf',
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        payload = {
            ...
            'time_minutes': 5,
            'price': Decimal(5.25),
            'tags': [{'name': 'Indian'}, {'name': 'Breadfast'}]
        }
        res =self.client.post(RECIPES_URL, payload, format='json')
